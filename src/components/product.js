    ...
    render() {
        ...
        return (
            <ProductWrapper className="col-9 mx-auto col-md-6 col-lg-3 my-3">
                <div className="card">
                    <div className="img-container p-5" onClick = {console.log('Clicked on img container')}>
                        <Link to="/details">
                            <img src={img} width="100px" height="250px" alt="product" title={title} className="card-img-top"></img>
                        </Link>
                        <button className="cart-btn" disabled={ inCart ? true : false } onClick={ () => (console.log(inCart)) }>
